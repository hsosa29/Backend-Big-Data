...
//Función para inicializar los filtros de ciudad y tipo
function init(){
    var tipos = [];
    var ciudades = [];
...
//Función para mostrar los datos, recibe un array con los datos resultados
...
//funcion para busqueda de acuerdo a los filtros
